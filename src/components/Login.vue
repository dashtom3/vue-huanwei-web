...
export default {
  ...
  data () {
    return {
      ...
      blocks:[[require('../assets/main/ab_01.png'),'定位系统','Main'],
              [require('../assets/main/ab_02.png'),'上报事情',''],
              [require('../assets/main/ab_03.png'),'例会列表',''],
              [require('../assets/main/ab_04.png'),'综合查询',''],
              [require('../assets/main/ab_05.png'),'信息录入',''],
              [require('../assets/main/ab_06.png'),'代办任务',''],
              [require('../assets/main/ab_06.png'),'奖惩信息','']]
    }
  },
  created(){
  },
