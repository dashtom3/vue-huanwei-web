...
export default {
  ...
  methods:{
    ...
    setUserContent(tempImg,name,isAlert){
      ...
      return '<div style="width:40px;text-align:center;"><img style="position:absolute;width:10px;height:8px;left:8px;"src="'+tempImg2+'"><img src="'+tempImg+'" style="width:25px"><div style="font-size:12px;background-color:'+color+';margin-top:-10px">'+name+'</div></div>'
    },
    addUserMarker(data){
      var temp = data.temp
    ...
    setCarContent(tempImg,name,isAlert){
      var color = isAlert == true? '#FF6666':'#99FF99'
      var tempImg2 = isAlert == true?require('../assets/work/alert_r.png'):require('../assets/work/alert_g.png')
      return '<div style="width:60px;text-align:center"><img style="position:absolute;width:15px;height:12px;left:10px;"src="'+tempImg2+'"><img src="'+tempImg+'" style="width:25px"><div style="font-size:12px;background-color:'+color+';margin-top:-10px">'+name+'</div></div>'
    },
    addCarMarker(data){
      var tempCoord = this.$transform.wgs84togcj02(data.lng,data.lat)
      data.lng = tempCoord[0]
